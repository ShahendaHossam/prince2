                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-6 mb-4">
                                <label>{{ __('Date') }}</label>
                                <input wire:model.lazy="business_case.approval_date" type="date" name="business_case.approval_date" id="business_case.approval_date" class="form-control">
                                @error('business_case.approval_date')
                            ...
                            <div class="col-6 mb-4">
                                <label>{{ __('Name') }}</label>
                                <input wire:model.lazy="business_case.name" type="text" name="business_case.name" id="business_case.name" class="form-control">
                                @error('business_case.name')
                                <span class="p-4 mb-4 text-sm text-red-800 rounded-lg text-red-400">{{ $message }}</span>
                                @enderror
                            </div>
                            <!-- End of Form -->
                            ...
                            <div x-data="signaturePad()" class="float-left">
                             ...
                             <textarea id="signature64" name="signed" wire:model.lazy="business_case.signature"></textarea>  --}}
                            </div>
                            <!-- End of Form -->
                        </div>
                        <div class="text-end">
