        ...
        <div class="py-4">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Monitor And Pre-requisities</li>
                </ol>
            </nav>
            <div class="d-flex justify-content-between w-100 flex-wrap">
                <div class="mb-3 mb-lg-0">
                    <h1 class="h4">Plan</h1>
                    <p class="mb-0">Edit Monitor And Pre-requisities</p>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-secondary" wire:click="update()" value="">
                                {{ __('Apply Changes') }} <span class="fas fa-save">
                            </button>
                            ...
                            <table class="table table-hover table-centered table-nowrap mb-0 rounded">
                                <thead class="thead-light">
                                    <tr>
                                        ...
                                        <th class="text-center border-0">{{ __('External Dependencies') }}</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a class="" wire:click="edit({{ $monitor_and_prerequisite->id }})"><span class="fas fa-edit me-2"></span></a>
                                        </td>
                                    </tr>
                                    @endif
                                    @endforeach
