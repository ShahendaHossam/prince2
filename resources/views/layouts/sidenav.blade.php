  ...
  <div class="sidebar-inner px-2 pt-3">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
     ...
     <li class="nav-item">
      ...
      <li class="nav-item">
        <span
          class="nav-link {{ Request::segment(1) !== 'business_case' ? 'collapsed' : '' }} d-flex justify-content-between align-items-center"
          data-bs-toggle="collapse" data-bs-target="#business_case_menu">
          <span>
            <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
            ...
            <span class="sidebar-text">Business Case</span>
          </span>
          <span class="link-arrow"><svg class="icon icon-sm" fill="currentColor" viewBox="0 0 20 20"
              xmlns="http://www.w3.org/2000/svg">
              <path fill-rule="evenodd"
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'business_case.index' ? 'show' : '' }}" role="list"
          id="business_case_menu" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(1) == 'business_case.index' ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('business_case.index') }}">
                <span class="sidebar-text">List</span>
              </a>
            </li>
          </ul>
        </div>
        <div class="multi-level collapse {{ Request::segment(1) == 'business_case.create' ? 'show' : '' }}" role="list"
          id="business_case_menu" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(1) == 'business_case.create' ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('business_case.create') }}">
      ...
      <li class="nav-item">
        <span
          class="nav-link {{ Request::segment(1) !== 'plan' ? 'collapsed' : '' }} d-flex justify-content-between align-items-center"
          data-bs-toggle="collapse" data-bs-target="#plan_menu">
          <span>
            <span class="sidebar-icon"><svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'plan.index' ? 'show' : '' }}" role="list"
          id="plan_menu" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(1) == 'plan.index' ? 'active' : '' }}">
        ...
        <div class="multi-level collapse {{ Request::segment(1) == 'plan.create' ? 'show' : '' }}" role="list"
          id="plan_menu" aria-expanded="false">
          <ul class="flex-column nav">
            <li class="nav-item {{ Request::segment(1) == 'plan.create' ? 'active' : '' }}">
              <a class="nav-link" href="{{ route('plan.create') }}">
                <span class="sidebar-text">Create</span>
              </a>
            </li>
          </ul>
